...
$constStr = [
    ...
    'EnvironmentsDescription' => [
        'en-us' => [
            ...
            'guestup_functionality_path' => 'Set the guestup_path directory where you want to load functional files (such as readme.md), and multiple directories are marked with "|" Separated',
        ...
        'zh-cn' => [
            ...
            'guestup_functionality_path' => '设置需要加载功能性文件（如readme.md）的guestup_path目录，多个目录用 “|” 分隔',
